...
import { DollarSign, Plus, CreditCard, Calendar, CheckCircle, Clock } from "lucide-react";

const mockPayments = [
  { id: "PAY-001", billId: "BILL-002", supplier: "Office World", amount: 459.50, method: "Credit Card", status: "completed", date: "2024-03-16", reference: "CC-789456123" },
  { id: "PAY-002", billId: "BILL-001", supplier: "Tech Supplies Inc", amount: 1299.99, method: "Bank Transfer", status: "pending", date: "2024-03-15", reference: "BT-456789012" },
  { id: "PAY-003", billId: "BILL-004", supplier: "Furniture Plus", amount: 899.99, method: "Check", status: "processing", date: "2024-03-14", reference: "CHK-12345678" },
  { id: "PAY-004", billId: "BILL-003", supplier: "Electronics Hub", amount: 2199.25, method: "Wire Transfer", status: "failed", date: "2024-03-13", reference: "WT-987654321" },
];
...
export default function PaymentTracking() {
  ...
  const getMethodIcon = (method: string) => {
    switch (method.toLowerCase()) {
      ...
      case "bank transfer": return <DollarSign className="w-4 h-4" />;
      case "check": return <Calendar className="w-4 h-4" />;
      case "wire transfer": return <DollarSign className="w-4 h-4" />;
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {payments.map((payment) => (
                <tr key={payment.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-900">{payment.billId}</td>
